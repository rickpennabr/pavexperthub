/**
 * BlogOptions Component
 * 
 * A dropdown component for selecting blog categories with a consistent design
...
export default function BlogOptions({ onSelect, selectedValue, onClear }: BlogOptionsProps) {
